#ifndef __FT_SGI_STL_INTERNAL_TREE_H
#define __FT_SGI_STL_INTERNAL_TREE_H
...
protected:
	...
	{
		_Link_type __tmp = _Base::_M_get_node();
		__STL_TRY {
		construct(&__tmp->_M_value_field, __x);
		}
		__STL_UNWIND(_Base::_M_put_node(__tmp));
		return __tmp;
	}
...
public:
	...
	typedef reverse_iterator<iterator> reverse_iterator; // reverse_bidirectional_iterator<iterator, value_type, reference, difference_type>
...
public:    
	...
	void swap(_Rb_tree<_Key,_Value,_KeyOfValue,_Compare,_Alloc>& __t) {
		__STD::swap(_Base::_M_header, __t._Base::_M_header);
...
#endif /* __FT_SGI_STL_INTERNAL_TREE_H */
